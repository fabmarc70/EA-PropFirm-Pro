...
<style>{`* { box-sizing: border-box; } .card { background: #111118; border: 1px solid #1e1e2e; border-radius: 12px; padding: 14px; margin-bottom: 12px; } .tab-btn { padding: 7px 12px; border-radius: 8px; border: none; cursor: pointer; font-size: 11px; font-weight: 800; } .tab-btn.on { background: #6ee7b7; color: #080810; } .tab-btn.off { background: #111118; color: #64748b; border: 1px solid #1e1e2e; } .model-btn { flex: 1; padding: 9px 4px; border-radius: 8px; cursor: pointer; font-size: 10px; font-weight: 800; border: 1px solid #1e1e2e; } .model-btn.on { background: #6ee7b7; color: #080810; border-color: #6ee7b7; } .model-btn.off { background: #111118; color: #64748b; } input[type=range] { width: 100%; accent-color: #6ee7b7; margin-top: 3px; } input[type=number] { background: #080810; border: 1px solid #1e1e2e; border-radius: 6px; color: #e2e8f0; padding: 5px 8px; width: 100%; font-size: 13px; } .row { display: flex; justify-content: space-between; padding: 7px 0; border-bottom: 1px solid #1e1e2e; font-size: 12px; } .row:last-child { border-bottom: none; } .tag { display: inline-block; padding: 2px 10px; border-radius: 20px; font-size: 10px; font-weight: 800; } .kpi { background: #0a0a14; border-radius: 8px; padding: 10px; }`}</style>
